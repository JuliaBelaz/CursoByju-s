...
striker.shapeColor = "DarkViolet";

var playerMallet = createSprite(200,50,50,10);
playerMallet.shapeColor = "HotPink";

var computerMallet = createSprite(200,350,50,10);
computerMallet.shapeColor = "HotPink";
...
if (gameState=="serve") {
  ...
  textSize(20);
  fill("OrangeRed");
  text("Pressione Espaço para Atacar",80,180);
